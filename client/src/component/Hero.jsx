    ...
    <div className="w-full flex flex-col items-center gap-5">
      ...
      {!isLoading&&(
        <div className="flex-col flex md:flex-row w-full my-5 items-center justify-center px-5">
            <img src={`https://titikgameserver.vercel.app/${highlight?.thumbnail}`} onClick={()=> setNavigate(true)} alt="thumbnail" className="w-full justify-center md:w-2/5 rounded-lg cursor-pointer"/>

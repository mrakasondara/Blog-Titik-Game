...
const Hero = () => {
  ...
  useEffect(()=>{
    fetch('https://blog-titik-games.vercel.app/api/highlight').then(response=>{
  ...
  return (
    <div className="w-full flex flex-col items-center gap-5">
      <div className='w-3/4 md:w-2/4 relative flex bg-[url(https://blog-titik-games.vercel.app/api/uploads/hero.png)] bg-cover bg-center justify-center items-center h-20 rounded-lg'>
      ...
      {!isLoading&&(
        <div className="flex-col flex md:flex-row w-full my-5 items-center justify-center px-5">
            <img src={`https://blog-titik-games.vercel.app/api/uploads/${highlight?.thumbnail}`} onClick={()=> setNavigate(true)} alt="thumbnail" className="w-full justify-center md:w-2/5 rounded-lg cursor-pointer"/>

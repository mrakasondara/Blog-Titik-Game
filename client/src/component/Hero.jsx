...
const Hero = () => {
  ...
  useEffect(()=>{
    fetch(`${import.meta.env.VITE_API_URL}/highlight`).then(response=>{
  ...
  return (
    <div className="w-full flex flex-col items-center gap-5">
      <div className=`w-3/4 md:w-2/4 relative flex bg-[url(${import.meta.env.VITE_API_URL}/uploads/hero.png)] bg-cover bg-center justify-center items-center h-20 rounded-lg`>
